...
# BRICK Fortran90
#
# Call sea-level rise model components, stepped forward together
#
...
# Input forcing:
#
#   temp.forcing        temperatuer forcing, rel to 1850 (deg C)
...
brick_slrF <- function(
  ...
  ns <- length(temp.forcing)

  # call fortran
  f.output <- .Fortran("run_brick",
        ns = ns,
        tstep = as.double(tstep),
        temp_forcing_in = as.double(temp.forcing),
        ...
        dais_b0 = as.double(b0.dais),
        dais_slope = as.double(slope.dais),
        dais_mu = as.double(mu.dais),
        dais_h0 = as.double(h0.dais),
        dais_c = as.double(c.dais),
        dais_chr = as.double(chr.dais),
        dais_P0 = as.double(P0.dais),
        dais_kappa = as.double(kappa.dais),
        dais_nu = as.double(nu.dais),
        dais_f0 = as.double(f0.dais),
        dais_gamma = as.double(gamma.dais),
        dais_alpha = as.double(alpha.dais),
        dais_Tfrz = as.double(Tf.dais),
        dais_rho_w = as.double(rho_w.dais),
        dais_rho_i = as.double(rho_i.dais),
        dais_rho_m = as.double(rho_m.dais),
        dais_Toc0 = as.double(Toc_0.dais),
        dais_Rad0 = as.double(Rad0.dais),
        dais_Aoc = as.double(Aoc.dais),
        dais_lf = as.double(lf),
