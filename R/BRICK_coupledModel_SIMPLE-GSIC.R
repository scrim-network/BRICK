...
##                        luse.dais, luse.waisdi, and luse.XXX, where XXX
...
brick_model = function(
  ...
  if (luse.brick[,"luse.gsic"]) {
	  ...
	  ## Grab SIMPLE-GSIC parameters
		...
		# GSIC expects temp.couple relative to late 1800s, which it already is
    ...
    gsic.out = simpleF(a=a.gsic, b=b.gsic, alpha=alpha.gsic,
											 beta=beta.gsic, V0=V0.gsic, Tg=temp.couple, i0=i0$gsic)
