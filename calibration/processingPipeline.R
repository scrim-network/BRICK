##==============================================================================
## processingPipeline.R
##
## Pipeline for processing DAIS calibration results and BRICK rest-of-model
## calibration results, and rejection sampling to global mean sea level data, to
## yield a fully-calibrated set of sea level model parameters, hindcasts, and
## projections under RCP 2.6, 4.5, 6.0 and 8.5 scenarios to 2100.
##
...
##    sea-level rise for user-defined lat/lon
##
...
## Source the appropriate BRICK model
