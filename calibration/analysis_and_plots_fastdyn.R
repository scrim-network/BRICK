...
ncdata <- nc_open(filename.brick.uniform)
  ...
  ais.rcp26.uni = ncvar_get(ncdata, 'AIS_RCP26')
  ais.rcp45.uni = ncvar_get(ncdata, 'AIS_RCP45')
  ais.rcp85.uni = ncvar_get(ncdata, 'AIS_RCP85')
...
ncdata <- nc_open(filename.brick.gamma)
  ...
  ais.rcp26.gam = ncvar_get(ncdata, 'AIS_RCP26')
  ais.rcp45.gam = ncvar_get(ncdata, 'AIS_RCP45')
  ais.rcp85.gam = ncvar_get(ncdata, 'AIS_RCP85')
...
print('==============================================================')
print('min/5%/50%/95%/max of 2100 Antarctic sea level relative to 1986-2005:')
print(paste('RCP2.6: ',quantile(ais.rcp26.gam[251,],c(0,.05,.50,.95,1))))
print(paste('RCP4.5: ',quantile(ais.rcp45.gam[251,],c(0,.05,.50,.95,1))))
print(paste('RCP8.5: ',quantile(ais.rcp85.gam[251,],c(0,.05,.50,.95,1))))
print('==============================================================')
