##==============================================================================
##
## Define parameters and their prior ranges. Includes fast dynamics parameters.
##
...
if (luse.dais) {
	...
	bound.lower.dais=c( 0.0    , 0      ,  0.5  , 0          , 7.05 , 0.003,0.026, 0.025      , 0.6, 735.5, 47.5, 740 , 4.5e-4, 0.000  , -20   ,0          )
	bound.upper.dais=c( 1.0    , 2      ,  4.25 , 1          , 13.65, 0.015, 1.5 , 0.085      , 1.8,2206.5,142.5, 820 , 7.5e-4, 0.030  , -10   ,2          )
